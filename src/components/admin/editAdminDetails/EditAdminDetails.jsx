...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://doctor-app-backend-no2v.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
