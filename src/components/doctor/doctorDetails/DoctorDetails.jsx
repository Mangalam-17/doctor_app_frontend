...
const DoctorDetails = () => {
    ...
    return (
        <div className='doctordetails'>
            <div className='doctorimage'><img className='doctorprofileimage' src={`https://doctor-app-backend-no2v.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
