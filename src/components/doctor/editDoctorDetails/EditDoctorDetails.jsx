...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctor-app-backend-no2v.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
