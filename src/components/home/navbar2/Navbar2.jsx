  ...
  return (
    <div className='navbar2'>
      ...
      <div className='navbar22'>
        <div className='navbar221'><img className='navbar221img' src={email} alt=''></img>kritahospital@gmail.com</div>
        <div className='navbar221'><img className='navbar222img' src={phone} alt=''></img>+910000000000</div>
